
{
    class Details {
        constructor() {
            ...
            <a href="#" class="btn btn-primary btn4">Add to Cart<i class="fa-solid fa-cart-arrow-down"></i></a>
            <a href="./order-done.html" class="details__addtocart btn4">Add to cart</a>
